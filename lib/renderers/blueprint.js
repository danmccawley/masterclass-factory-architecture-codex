...
//
// The four brief-derived helpers this needs (classTierSpec, totalSlideTarget,
// knowledgeBaseStandard, wantsDeepDives) now live in lib/util.js (Sprint 3,
// module 4) and are required directly. They were briefly injected as a deps
// object while those helpers still lived in generate.js (a circular require
// otherwise); with a shared util module they have a real home.
"use strict";

const { classTierSpec, totalSlideTarget, knowledgeBaseStandard, wantsDeepDives } = require("../util.js");
