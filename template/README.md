...
└── api/
    ...
    └── quality.js    # quality + participation report   — no tokens
```
...
`OPENAI_API_KEY` (chat+grade+quality+tts) · optional `OPENAI_MODEL` (defaults to GPT-5.5) · `KV_REST_API_URL` · `KV_REST_API_TOKEN` · `POLL_ADMIN_KEY`
