...
## Question 1
What should factual claims in bake bread connect back to?
Answer: The approved source paper
Why: Every factual claim should connect to the approved source paper or be removed.

## Question 2
Terminal and enabling learning objectives should be finalized after knowledge-base analysis.
Answer: true
Why: The objectives need to match the sources, learner profile, and scope rules.

## Question 3
Name one thing the source-verification gate should block.
Answer: undefined
