/* ============================================================================
   ENGINE — how to install fiber in a data center  ·  Master Class
   ----------------------------------------------------------------------------
...
(function(){
  ...
  function openChat(prefill){
    ...
    if(!history.length){
      addMsg("a", "Ask me anything about how to install fiber in a data center — the key ideas, source evidence, practice steps, and checks for understanding.");
    }
  ...
  (function(){
    ...
    Array.prototype.forEach.call(menu.querySelectorAll(".sel-opt"), function(btn){
      btn.addEventListener("click", function(e){
        ...
        var prompts = {
          definition: "I'm in a class on how to install fiber in a data center. Define \u201c"+phrase+"\u201d in plain language.",
          context:    "In the context of this class on how to install fiber in a data center, what does \u201c"+phrase+"\u201d mean here and how is it being used?",
          relevance:  "Why does \u201c"+phrase+"\u201d matter in how to install fiber in a data center? Explain its relevance to this class.",
          general:    "I have a question about \u201c"+phrase+"\u201d from this class on how to install fiber in a data center: "
        };
  ...
  window.askAboutTerm = function(term){
    ...
    openChat("In the context of this class on how to install fiber in a data center, explain \u201c" + term + "\u201d and why it matters.");
  };
