/* ============================================================================
   ENGINE — how to boil an egg  ·  Master Class
   ----------------------------------------------------------------------------
...
(function(){
  ...
  var CLASS_SLUG = (window.DECK_META && window.DECK_META.slug) ||
    String(window.CLASS_TITLE || "how to boil an egg").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"") ||
    "masterclass";
  ...
  window.submitFeedback = function(){
    ...
    fetch("/api/feedback", {
      ...
      body: JSON.stringify({ class_title: window.CLASS_TITLE || "how to boil an egg", class_slug: CLASS_SLUG, slide: s.id || "", slideNum: String(idx+1), context: _fbContext, text: text })
  ...
  function openChat(prefill){
    ...
    if(!history.length){
      addMsg("a", "Hello, I'm Bernard. Ask me anything about how to boil an egg — the key ideas, source evidence, practice steps, and checks for understanding.");
    }
  ...
  (function(){
    ...
    Array.prototype.forEach.call(menu.querySelectorAll(".sel-opt"), function(btn){
      btn.addEventListener("click", function(e){
        ...
        var prompts = {
          definition: "I'm in a class on how to boil an egg. Define \u201c"+phrase+"\u201d in plain language.",
          context:    "In the context of this class on how to boil an egg, what does \u201c"+phrase+"\u201d mean here and how is it being used?",
          relevance:  "Why does \u201c"+phrase+"\u201d matter in how to boil an egg? Explain its relevance to this class.",
          general:    "I have a question about \u201c"+phrase+"\u201d from this class on how to boil an egg: "
        };
  ...
  window.askAboutTerm = function(term){
    ...
    openChat("In the context of this class on how to boil an egg, explain \u201c" + term + "\u201d and why it matters.");
  };
  ...
  function qualityPayload(){
    return {
      class_title: window.CLASS_TITLE || "how to boil an egg",
