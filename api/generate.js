...
// this scope so the orchestration layer (resolveKnowledgeBase, buildSourcePaper,
// detectAdvancementOpportunity) and the _internal test export resolve unchanged.
const {
